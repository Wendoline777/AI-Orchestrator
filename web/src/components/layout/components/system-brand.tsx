...
export function SystemBrand(props: SystemBrandProps) {
  ...
  if (variant === 'inline') {
    return (
      ...
      >
        <div className='flex size-5 items-center justify-center overflow-hidden rounded-full bg-white p-px'>
          <img
            src={logo}
            alt={t('Logo')}
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          ...
          render={<div />}
        >
          <div className='flex aspect-square size-8 items-center justify-center overflow-hidden rounded-full bg-white p-0.5'>
            <img
              src={logo}
              alt={t('Logo')}
              className='size-full object-contain'
