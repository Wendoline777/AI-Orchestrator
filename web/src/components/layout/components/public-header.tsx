...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  let authContent = isAuthenticated ? (
    <ProfileDropdown />
  ) : (
    <Button
      size='sm'
  ...
  return (
    <>
      <header className='border-primary bg-background/95 pointer-events-none fixed inset-x-0 top-0 z-50 border-t-4 backdrop-blur-xl'>
        <div
          className={cn(
        ...
        >
          <nav
            className={cn(
              ...
              scrolled ? 'border-border h-16 border-b px-2' : 'h-16 px-2'
            )}
          >
            {/* Logo */}
            <Link
            ...
            >
              <div className='flex size-10 shrink-0 items-center justify-center rounded-full bg-white p-0.5'>
                {logoContent}
              </div>
              <div>
                <span className='text-primary block text-base font-semibold tracking-tight'>
                  {loading ? (
                ...
                <span className='text-muted-foreground block text-[10px] tracking-wider'>
            ...
            <div className='flex items-center gap-2 lg:hidden'>
              ...
              <Button
                ...
                aria-controls='campus-mobile-navigation'
              >
