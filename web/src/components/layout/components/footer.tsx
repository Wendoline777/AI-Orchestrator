...
export function Footer(props: FooterProps) {
  ...
  const fallbackColumns = useMemo<FooterColumnProps[]>(
    () => [
      {
        title: t('Learning services'),
        links: [
          { text: t('Learning workspace'), href: '/dashboard' },
          { text: t('Model resources'), href: '/pricing' },
          { text: t('Platform guide'), href: '/about' },
        ],
      },
      {
        title: t('Campus resources'),
        links: [
          {
            text: t('Dalian University of Technology'),
            href: 'https://www.dlut.edu.cn/',
          },
          {
            text: t('DUT Library'),
            href: 'https://www.lib.dlut.edu.cn/',
          },
          {
            text: t('Undergraduate education'),
            href: 'https://teach.dlut.edu.cn/',
          },
        ],
      },
    ],
  ...
  return (
    <footer
      className={cn(
        'border-primary/15 bg-primary/3 relative z-10 border-t',
        props.className
      )}
    >
        ...
        <div className='flex flex-col justify-between gap-10 md:flex-row md:gap-16'>
          ...
          <div className='max-w-md'>
            ...
            <p className='text-muted-foreground mt-4 text-sm leading-7'>
              {t('AI services for student learning and research.')}
            </p>
            <p className='text-muted-foreground mt-2 max-w-sm text-xs leading-6'>
              {t(
                'Respect academic integrity. Verify AI-generated content and protect personal and research data.'
              )}
            </p>
          </div>

          <nav
            aria-label={t('Student service links')}
        ...
        <div className='border-border/30 mt-12 flex flex-col items-center justify-between gap-x-3 gap-y-2 border-t pt-6 sm:flex-row'>
          <div className='text-muted-foreground flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-xs sm:justify-start'>
            <span>
              ...
              {props.copyright ??
                t('For learning and research. Use AI responsibly.')}
            </span>
